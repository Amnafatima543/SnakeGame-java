...
public class SnakeGame extends JPanel implements ActionListener, KeyListener {
	...
	public void draw(Graphics g) {
        ...
        public void placeFood(){
            food.x = random.nextInt(boardWidth / tileSize); // Calculate random x position in terms of tiles
            food.y = random.nextInt(boardHeight / tileSize); // Calculate random y position in terms of tiles
        }
